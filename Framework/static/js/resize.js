var htmEditor,cssEditor,jsEditor;
...
$('#versions').selectpicker({style:'btn-xs'});
$('#includes').selectpicker({style:'btn-xs'});
$('#includes').change(function(ele){
});

$('#themes').selectpicker({style:'btn-xs'});

$('#tags').selectpicker({style:'btn-xs'});
